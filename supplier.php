            ...
            <div class="right-side">
                ...
                <div class="info">
                    ...
                    <div class="edit-buttons">
                        <button id="edit-profile" data-workerid="<?php echo $row['supplier_id'] ?>" data-fname="<?php echo $row['f_name'] ?>" data-lname="<?php echo $row['l_name'] ?>" data-contactnumber="<?php echo $row['contact_number'] ?>" data-company="<?php echo $row['company_name'] ?>">Edit Profile</button>
                        <button id="edit-acc" data-accid="<?php echo $row['account_id'] ?>" data-username="<?php echo $row['username'] ?>">Edit Account</button>
                    </div>
                </div>
            </div>
