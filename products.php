...
$ending_page = min($total_pages, $starting_page + 3);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="form-container">
                    ...
                    <form action="add/addproduct.php" method="post" id="form-body">
                        ...
                        <div class="input-body">
                            ...
                            <input type="number" id="kilogram" name="kilogram" inputmode="numeric">
                            <p class="emptyinput" id="kilogramerr">Kilogram cannot be blank</p>
                        </div>

                        <div class="input-body">
                            <label for="price">Price</label>
                            <input type="number" id="price" name="price" inputmode="numeric">
                ...
                <div class="page">
                    ...
                    <ul class="page-list">
                        ...
                        <?php for ($i = $starting_page; $i <= $ending_page; $i++) { ?>
                            <li><a href="<?php echo "products.php?page_number=" . $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php } ?>
