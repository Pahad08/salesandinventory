            ...
            <div class="right-side">
                ...
                <div class="info">
                    ...
                    <div class="edit-buttons">
                        <button id="edit-profile" data-workerid="<?php echo $row['worker_id'] ?>" data-fname="<?php echo $row['f_name'] ?>" data-lname="<?php echo $row['l_name'] ?>" data-contactnumber="<?php echo $row['contact_number'] ?>">Edit Profile</button>
