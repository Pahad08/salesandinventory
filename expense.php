    ...
    <div class="body">
        ...
        <div class="body-content">
                ...
                <div class="form-container">
                    ...
                    <form action="add/addexpense.php" method="post" id="form-body">
                        ...
                        <div class="input-body">
                            ...
                            <input type="number" id="amount" name="amount" inputmode="numeric">
            ...
            <div class="data-body">
                ...
                <form action="delete/deleteexpense.php" id="deleteexpense" method="post" class="form-table">
                    <table id="table">
                        <tr id="head">
                            <th></th>
                            <th>Description</th>
                        ...
                        <?php while ($row) { ?>
                            <tr>
                                <td><input type="checkbox" name="expense_id[]" value="<?php echo $row['expense_id']; ?>" class="checkbox"></td>
                                <td><?php echo $row['description']; ?></td>
                                <td><?php echo $row['amount']; ?></td>
                                <td><?php echo $row['expense_date']; ?></td>
                                <td id="action"> <button class="edit" data-expenseid="<?php echo $row['expense_id']; ?>" data-description="<?php echo $row['description']; ?>" data-amount="<?php echo $row['amount']; ?>"><img src="images/edit.png" alt="">Edit</button>
                                </td>
                            </tr>
                ...
                <div class="page">
                    ...
                    <ul class="page-list">
                        ...
                        <?php for ($i = $starting_page; $i <= $ending_page; $i++) { ?>
                            <li><a href="<?php echo "expense.php?page_number=" . $i; ?>"><?php echo $i; ?></a>
                            </li>
                        <?php } ?>
