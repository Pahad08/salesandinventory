        ...
        <div class="body-content">
            ...
            <div class="form" id="form">
                ...
                <div class="form-container">
                    ...
                    <form action="add/addworker.php" method="post" id="form-worker">
                    ...
                    <table id="table">
                        ...
                        <?php while ($row) { ?>
                            <tr>
                                ...
                                <td id="action"> <button class="edit" data-workerid="<?php echo $row['worker_id']; ?>" data-fname="<?php echo $row['f_name']; ?>" data-lname="<?php echo $row['l_name']; ?>" data-number="<?php echo $row['contact_number']; ?>"><img src="images/edit.png" alt="">Edit</button>
                                </td>
                            </tr>
